...
const onLightTopicChange = topic => {
    ...
    document.documentElement.style.setProperty(
        '--background-color',
        'var(--background-color-light-topic)'
    );
    ...
    document.documentElement.style.setProperty(
        ...
        'var(--minor-background-color-light-topic)'
    );
...
const onDarkTopicChange = topic => {
    ...
    document.documentElement.style.setProperty(
        '--background-color',
        'var(--background-color-dark-topic)'
    );
    ...
    document.documentElement.style.setProperty(
        '--minor-background-color',
        'var(--minor-background-color-dark-topic)'
    );
